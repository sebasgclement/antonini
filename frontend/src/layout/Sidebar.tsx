  ...
  return (
    <div
      style={{
        ...
        marginBottom: 20,
        padding: "12px 14px",
        background: "var(--color-card)", // Usar variable del tema o un color sólido suave
        borderRadius: 8,
        border: "1px solid var(--border-color)",
        // ESTOS DOS EVITAN QUE SE ROMPA EL ANCHO:
        width: "100%",
      ...
      {isEditing ? (
        ...
        <div className="vstack" style={{ gap: 6, width: "100%" }}>
          <input
            ...
            style={{
              width: "100%",
              boxSizing: "border-box", // Vital para que no se salga
        ...
        >
          ...
          <button
            onClick={handleEdit}
            className="btn-icon-hover" // Clase auxiliar si existe, sino usa style
            style={{
...
export default function Sidebar({ onClose }: { onClose?: () => void }) {
  ...
  return (
    // ⚠️ CLAVE: overflowX: 'hidden' para matar el scroll horizontal
    <div
    ...
    >
      ...
      {/* Menú Scrollable */}
      {/* ⚠️ CLAVE: boxSizing border-box y width 100% */}
      <nav
        style={{
          flex: 1,
          overflowY: "auto",
