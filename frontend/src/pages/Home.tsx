    ...
    <div className="container vstack" style={{ gap: 32, paddingBottom: 40 }}>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 280 }}>
          <h1
            className="title"
            style={{ fontSize: "2rem", margin: 0, marginBottom: 8 }}
          >
        ...
        {/* Widget Fecha (El del Dólar ahora está en el Sidebar) */}
        <div
          style={{
      ...
      <div className="card vstack" style={{ marginTop: 10, padding: 20 }}>
        <div
          className="title"
          style={{ fontSize: "1rem", margin: 0, borderBottom: "none" }}
        >
          Listados Completos
        </div>
        <div className="hstack" style={{ flexWrap: "wrap", gap: 12 }}>
          <Link
            to="/vehiculos"
            className="enlace"
            style={{ background: "var(--hover-bg)", padding: "8px 16px" }}
          >
            🚙 Ver Stock Completo
          </Link>
          <Link
