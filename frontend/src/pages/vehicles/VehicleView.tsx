...
export default function VehicleView() {
  ...
  // FUNCIÓN INTELIGENTE DE VOLVER
  const handleBack = () => {
    // ¿Me mandaron un origen específico? (Ej: vengo de la reserva)
    if (location.state?.from) {
      nav(location.state.from);
    } else {
      // Si no, comportamiento por defecto (ir al listado de vehículos)
      nav("/vehiculos");
    }
  };
  ...
  return (
    <div className="container vstack detail-page" style={{ gap: 24 }}>
        ...
        <div className="card vstack" style={{ gap: 20 }}>
          ...
          >
            ...
            <DataItem
              ...
              value={
                vehicle.take_price
                  ? `$ ${vehicle.take_price.toLocaleString()}`
                  : "—"
              }
            />
          </div>
          ...
          >
            <DataItem
              ...
              value={
                <span
                  className={`badge ${
                    vehicle.ownership === "propio" ? "purple" : "blue"
                  }`}
                >
      ...
      <div className="card">
        <div className="title" style={{ fontSize: "1.1rem", marginBottom: 16 }}>
          Estado de Recepción
        </div>
            ...
            <div
              ...
              style={{
                ...
                background: item.val
                  ...
                  : "var(--input-bg)",
                border: `1px solid ${
                  item.val ? "transparent" : "var(--color-border)"
                }`,
      ...
      <div className="card">
        <div className="hstack" style={{ justifyContent: "space-between" }}>
          ...
          <Button
            onClick={() => nav(`/vehiculos/${id}/gastos`)}
              ...
              {expenses.map((exp, i) => (
                <tr key={i}>
                  ...
                  <td>
                    <span
                      className={`badge ${
                        exp.status === "pagado" ? "green" : "orange"
                      }`}
                    >
      ...
      <div className="card">
        ...
        {!Object.keys(vehicle).some(
          (k) => k.startsWith("photo_") && vehicle[k]
        ) && (
