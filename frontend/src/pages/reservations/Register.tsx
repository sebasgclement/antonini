...
export default function RegisterReservation() {
  ...
  const totalPaid =
    (includeDeposit
      ...
      : 0) + (includeUsed ? Number(usedValue) || 0 : 0);
  ...
  return (
    <div className="container vstack" style={{ gap: 20 }}>
      ...
      <form
        onSubmit={onSubmit}
        className="vstack"
        style={{ gap: 20, paddingBottom: 100 }}
      >
        ...
        <div className="card vstack" style={{ gap: 16 }}>
          ...
          <div style={{ marginTop: 8 }}>
            ...
            {hasCoowner && (
              <div
                className="hstack"
                style={{ marginTop: 12, alignItems: "end", gap: 10 }}
              >
                <Input
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          Valor de Toma ({currency}):
                        </label>
                        <Input
                          type="number"
                          value={usedValue as any}
                          onChange={(e) =>
                            setUsedValue(parseFloat(e.currentTarget.value))
                          }
                          style={{
                            width: 140,
                            fontWeight: "bold",
